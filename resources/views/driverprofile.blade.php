                ...
                <div class="relative z-10 flex flex-col md:flex-row items-center gap-10">
                    <div class="relative">
                        ...
                        <label for="upload-photo"
                            class="absolute -bottom-2 -right-2 w-8 h-8 bg-blue-600 rounded-lg flex items-center justify-center border-4 border-[#050505] cursor-pointer hover:bg-blue-500 transition">
                    ...
                    <div class="flex-1 space-y-6 w-full">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div class="space-y-1">
                                <label class="text-[10px] uppercase font-black text-blue-500 tracking-[0.2em]">Full
                                    Name</label>
                            ...
                            <div class="space-y-1">
                                <label class="text-[10px] uppercase font-black text-blue-500 tracking-[0.2em]">Email
                                    Address</label>
                                <div class="glass p-4 rounded-2xl text-sm font-semibold border-white/5 bg-white/[0.02]">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
                ...
                <div class="glass p-6 rounded-3xl border-white/5">
                    ...
                    <p class="text-sm font-bold flex items-center">
                        <i class="fa-solid fa-star text-yellow-500 mr-2 text-[10px]"></i> 4.9 <span
                            class="text-gray-500 font-normal ml-1">(142 trips)</span>
                    </p>
                </div>
            </div>
        </div>
