...
<head>
    ...
    <style>
        ...
        *::after {
        ...
        /* Preserve element-specific transitions */
        .header-btn {
    ...
    <header
        ...
        <div class="flex items-center gap-2 pointer-events-auto z-50 shrink-0">
            ...
            <a href="{{ route('profile') }}"
                class="header-btn glass-panel w-9 h-9 rounded-xl flex items-center justify-center text-white cursor-pointer">
                <i class="fa-solid fa-circle-user text-[10px] text-slate-400 dark:text-[#555]"></i>
            </a>
        </div>
    </header>
