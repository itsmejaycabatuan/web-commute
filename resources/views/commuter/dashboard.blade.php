...
<body class="antialiased bg-slate-900">
    ...
    <div class="fixed top-28 right-6 w-80 z-40 hidden lg:flex flex-col gap-4 max-h-[calc(100vh-140px)]">
        ...
        <div
            ...
            <div class="flex justify-between items-start mb-4">
                <div>
                    <p class="text-[9px] uppercase tracking-widest text-white/60 font-bold mb-1">Live Vehicle Status</p>
            ...
            <div class="mt-3 text-[10px] text-white/40 text-center">
                <i class="fa-solid fa-map-marker-alt"></i> Click the GPS button (📍) on the map to track your location
            </div>
        </div>
    </div>
