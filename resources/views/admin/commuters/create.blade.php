...
<head>
    ...
    <title>Add commuter — SmartCommute</title>
...
<body x-data="{ open: true }">
    ...
    <main :class="open ? 'ml-72' : 'ml-20'" class="sidebar-transition min-h-screen p-8 md:p-12">
        <div class="mx-auto w-full max-w-lg">
            ...
            <h2 class="text-2xl font-black tracking-tight mb-2">Add commuter</h2>
            <p class="text-gray-500 text-sm mb-8">Create a new PUJ passenger account.</p>

            <div class="glass rounded-2xl border border-white/10 p-8">
                <form action="{{ route('admin.commuters.store') }}" method="POST" class="space-y-5">
                    @csrf
                    <div>
                    ...
                    <label class="flex items-center gap-2 cursor-pointer">
                        ...
                        <span class="text-xs text-gray-400">Mark email as verified</span>
                    </label>
                    <button type="submit"
