    ...
    <div x-data="{ showDetailModal: false, selectedTx: null }">
        ...
        <main :class="$store.sidebar.open ? 'md:ml-72' : 'md:ml-20'"
            ...
            <div class="hidden lg:block mb-8">
                ...
                <h1 class="text-2xl sm:text-3xl font-black tracking-tight">Wallet <span
                        class="text-emerald-400">Top-ups</span></h1>
            ...
            <div class="grid grid-cols-2 xl:grid-cols-4 gap-3 sm:gap-4 mb-5 sm:mb-6">
                ...
                <div class="glass-card p-4 sm:p-5 rounded-[1.25rem] border-l-2 border-l-emerald-500">
                    ...
                    <div class="flex items-baseline gap-1">
                        <span
                            class="text-2xl sm:text-3xl font-black tracking-tight text-emerald-400">₱{{ number_format($totalFundsAdded, 2) }}</span>
                    </div>
                </div>
                ...
                <div class="glass-card p-4 sm:p-5 rounded-[1.25rem] border-l-2 border-l-blue-500">
                    <div class="flex items-center gap-2 mb-2 sm:mb-3">
                        ...
                        <span
                            class="text-[7px] sm:text-[8px] font-bold uppercase tracking-[0.15em] text-[#444]">Top-ups</span>
                    </div>
                    <div class="flex items-baseline gap-1 sm:gap-1.5">
                        <span
                            class="text-2xl sm:text-3xl font-black tracking-tight">{{ number_format($totalTopupCount) }}</span>
                    </div>
                </div>
                ...
                <div class="glass-card p-4 sm:p-5 rounded-[1.25rem] border-l-2 border-l-purple-500">
                    <div class="flex items-center gap-2 mb-2 sm:mb-3">
                        ...
                        <span class="text-[7px] sm:text-[8px] font-bold uppercase tracking-[0.15em] text-[#444]">Avg
                            Top-up</span>
                    </div>
                    <div class="flex items-baseline gap-1">
                        <span
                            class="text-2xl sm:text-3xl font-black tracking-tight text-purple-400">₱{{ number_format($avgTopup, 2) }}</span>
                    </div>
                </div>
                ...
                <div class="glass-card p-4 sm:p-5 rounded-[1.25rem] border-l-2 border-l-amber-500">
                    <div class="flex items-center gap-2 mb-2 sm:mb-3">
                        ...
                        <span class="text-[7px] sm:text-[8px] font-bold uppercase tracking-[0.15em] text-[#444]">Top
                            Method</span>
                    </div>
                    <div class="flex items-baseline gap-1.5">
                        <span
                            class="text-lg sm:text-xl font-black tracking-tight text-amber-400">{{ $topMethod ?? 'N/A' }}</span>
                    </div>
                    <p class="text-[7px] sm:text-[8px] text-[#333] mt-1 font-medium"
            ...
            <div class="glass-card rounded-[1.25rem] p-4 sm:p-5 mb-5">
                <form action="{{ route('admin.topups') }}" method="GET" class="flex flex-col sm:flex-row gap-3">
                    <div class="relative flex-1">
                        <i
                            class="fa-solid fa-magnifying-glass absolute left-3.5 top-1/2 -translate-y-1/2 text-[10px] text-[#333]"></i>
                    ...
                    <div class="relative">
                        <i
                            class="fa-regular fa-calendar absolute left-3.5 top-1/2 -translate-y-1/2 text-[10px] text-[#333]"></i>
                                ...
                                <tr class="table-row">
                                    <td class="px-4 sm:px-6 py-3.5">
                                        <div class="flex items-center gap-3">
                                            ...
                                            <div class="min-w-0">
                                                <p
                                                    class="text-[10px] sm:text-[11px] font-bold text-[#ccc] truncate max-w-[200px]">
                                                    {{ $tx->user->email }}</p>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-4 sm:px-6 py-3.5">
                                        <span
                                            class="text-[10px] font-bold text-emerald-400 font-mono">#{{ $tx->id }}</span>
                                    </td>
                                    <td class="px-4 sm:px-6 py-3.5">
                                        <span
                                            class="text-[7px] sm:text-[8px] bg-{{ $methodColor }}-500/10 text-{{ $methodColor }}-400 border border-{{ $methodColor }}-500/15 px-2 py-0.5 rounded-md font-bold uppercase">{{ $tx->payment_method }}</span>
                                    </td>
                                    <td class="px-4 sm:px-6 py-3.5">
                                        <span
                                            class="text-[10px] font-bold text-[#888]">{{ $tx->created_at->format('M j, Y') }}</span>
                                        <p class="text-[8px] text-[#444]">{{ $tx->created_at->format('g:i A') }}</p>
                                    </td>
                                    <td class="px-4 sm:px-6 py-3.5 text-right">
                                        <span
                                            class="text-[11px] font-bold text-emerald-400">+₱{{ number_format($tx->amount_added, 2) }}</span>
                                    </td>
                                    <td class="px-4 sm:px-6 py-3.5 text-right">
                                        <button
                                            ...
                                            title="View details">
                                            <i
                                                class="fa-solid fa-arrow-up-right-from-square text-[8px] text-[#444] group-hover:text-white transition"></i>
                                        </button>
                                    </td>
                                </tr>
                            @empty
            ...
            <div class="glass-panel p-6 sm:p-8 rounded-[2rem] max-w-sm w-full">
                ...
                <div class="space-y-2.5">
                    <div
                        ...
                        <div class="flex items-center gap-3">
                            <div
                                class="w-7 h-7 rounded-lg bg-[#111] border border-[#1e1e1e] flex items-center justify-center shrink-0">
                        ...
                        <span class="text-[10px] font-bold text-[#ccc] truncate max-w-[160px]"
                    ...
                    <div
                        ...
                        <span class="text-[12px] font-black text-emerald-400"
