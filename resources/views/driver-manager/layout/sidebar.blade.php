    ...
    <div class="bg-[#0a0a0a]/95 backdrop-blur-xl border-t border-[#1a1a1a] px-2 pb-[env(safe-area-inset-bottom)]">
        <div class="flex items-center justify-around py-1.5">
            ...
            <a href="{{ route('driver-manager.time-keeping') }}"
                class="flex flex-col items-center gap-0.5 py-1.5 px-3 rounded-xl transition-all active:scale-90 {{ request()->routeIs('driver-manager.time-keeping') ? 'text-blue-400' : 'text-[#444]' }}">
                <i class="fa-solid fa-clock text-[15px]"></i>
                <span class="text-[7px] font-bold uppercase tracking-wider">Time</span>
            </a>
            <a href="{{ route('driver-manager.violations-log') }}"
                class="flex flex-col items-center gap-0.5 py-1.5 px-3 rounded-xl transition-all active:scale-90 {{ request()->routeIs('driver-manager.violations-log') ? 'text-blue-400' : 'text-[#444]' }}">
                <i class="fa-solid fa-list text-[15px]"></i>
                <span class="text-[7px] font-bold uppercase tracking-wider">Logs</span>
            </a>
...
<div id="mobile-drawer"
    ...
    <nav class="flex-1 p-3 space-y-1 overflow-y-auto">
        ...
        <a href="{{ route('driver-manager.time-keeping') }}"
            class="flex items-center gap-3 px-3 py-2.5 rounded-xl transition-all border {{ request()->routeIs('driver-manager.time-keeping') ? 'bg-blue-500/[0.06] text-blue-400 border-blue-500/15' : 'text-[#555] border-transparent hover:bg-[#111] hover:text-[#888]' }}">
            <div class="w-7 h-7 rounded-lg {{ request()->routeIs('driver-manager.time-keeping') ? 'bg-blue-500/10' : 'bg-[#111]' }} flex items-center justify-center shrink-0">
                <i class="fa-solid fa-clock text-[10px]"></i>
            </div>
            <span class="text-[10px] font-bold uppercase tracking-[0.12em]">Time Keeping</span>
        </a>
        ...
        <a href="{{ route('driver-manager.violations-log') }}"
            class="flex items-center gap-3 px-3 py-2.5 rounded-xl transition-all border {{ request()->routeIs('driver-manager.violations-log') ? 'bg-blue-500/[0.06] text-blue-400 border-blue-500/15' : 'text-[#555] border-transparent hover:bg-[#111] hover:text-[#888]' }}">
            <div class="w-7 h-7 rounded-lg {{ request()->routeIs('driver-manager.violations-log') ? 'bg-blue-500/10' : 'bg-[#111]' }} flex items-center justify-center shrink-0">
                <i class="fa-solid fa-list text-[10px]"></i>
            </div>
            <span class="text-[10px] font-bold uppercase tracking-[0.12em]">Violations Log</span>
        </a>

        <a href="{{ route('driver-manager.violation-codes') }}"
            class="flex items-center gap-3 px-3 py-2.5 rounded-xl transition-all border {{ request()->routeIs('driver-manager.violation-codes') ? 'bg-blue-500/[0.06] text-blue-400 border-blue-500/15' : 'text-[#555] border-transparent hover:bg-[#111] hover:text-[#888]' }}">
            <div class="w-7 h-7 rounded-lg {{ request()->routeIs('driver-manager.violation-codes') ? 'bg-blue-500/10' : 'bg-[#111]' }} flex items-center justify-center shrink-0">
                <i class="fa-solid fa-road text-[10px]"></i>
            </div>
            <span class="text-[10px] font-bold uppercase tracking-[0.12em]">Violation Codes</span>
        </a>
...
<aside :class="open ? 'w-[270px] p-3' : 'w-[76px] p-2'"
    ...
    <div>
        ...
        <nav class="space-y-1">
            ...
            <a href="{{ route('driver-manager.time-keeping') }}"
                :class="open ? 'gap-3 px-3' : 'justify-center px-0'"
                class="flex items-center py-2.5 rounded-xl transition-all border group {{ request()->routeIs('driver-manager.time-keeping') ? 'bg-blue-500/[0.06] text-blue-400 border-blue-500/15' : 'text-[#555] border-transparent hover:bg-[#111] hover:text-[#888] hover:border-[#1a1a1a]' }}">
                <div class="w-8 h-8 rounded-lg {{ request()->routeIs('driver-manager.time-keeping') ? 'bg-blue-500/10' : 'bg-[#111] group-hover:bg-[#161616]' }} flex items-center justify-center shrink-0 transition">
                    <i class="fa-solid fa-clock text-[11px]"></i>
                </div>
                <span x-show="open" x-transition.opacity.duration.200ms class="text-[10px] font-bold uppercase tracking-[0.12em] whitespace-nowrap">Time Keeping</span>
            </a>
            ...
            <a href="{{ route('driver-manager.violations-log') }}"
                :class="open ? 'gap-3 px-3' : 'justify-center px-0'"
                class="flex items-center py-2.5 rounded-xl transition-all border group {{ request()->routeIs('driver-manager.violations-log') ? 'bg-blue-500/[0.06] text-blue-400 border-blue-500/15' : 'text-[#555] border-transparent hover:bg-[#111] hover:text-[#888] hover:border-[#1a1a1a]' }}">
                <div class="w-8 h-8 rounded-lg {{ request()->routeIs('driver-manager.violations-log') ? 'bg-blue-500/10' : 'bg-[#111] group-hover:bg-[#161616]' }} flex items-center justify-center shrink-0 transition">
                    <i class="fa-solid fa-list text-[11px]"></i>
                </div>
                <span x-show="open" x-transition.opacity.duration.200ms class="text-[10px] font-bold uppercase tracking-[0.12em] whitespace-nowrap">Violations Log</span>
            </a>

            <a href="{{ route('driver-manager.violation-codes') }}"
                :class="open ? 'gap-3 px-3' : 'justify-center px-0'"
                class="flex items-center py-2.5 rounded-xl transition-all border group {{ request()->routeIs('driver-manager.violation-codes') ? 'bg-blue-500/[0.06] text-blue-400 border-blue-500/15' : 'text-[#555] border-transparent hover:bg-[#111] hover:text-[#888] hover:border-[#1a1a1a]' }}">
                <div class="w-8 h-8 rounded-lg {{ request()->routeIs('driver-manager.violation-codes') ? 'bg-blue-500/10' : 'bg-[#111] group-hover:bg-[#161616]' }} flex items-center justify-center shrink-0 transition">
                    <i class="fa-solid fa-road text-[11px]"></i>
                </div>
                <span x-show="open" x-transition.opacity.duration.200ms class="text-[10px] font-bold uppercase tracking-[0.12em] whitespace-nowrap">Violation Codes</span>
            </a>
