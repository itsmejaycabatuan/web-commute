        ...
        <nav class="space-y-2">
            <nav class="space-y-2">
                <a href="{{ route('dashboard') }}"
                    class="flex items-center gap-4 p-3 rounded-2xl transition-all group border {{ request()->routeIs('dashboard') ? 'bg-blue-600/10 text-blue-400 border-blue-500/20' : 'text-gray-400 border-transparent hover:bg-white/5' }}">
