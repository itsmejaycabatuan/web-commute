...
<body class="font-sans text-white bg-[#050505] overflow-x-hidden">
        ...
        <nav class="flex-1 p-6 space-y-2">
            ...
            <div class="pt-4">
                ...
                <a href="#features" onclick="closeMobileMenu()"
                    class="block px-4 py-3 text-sm text-gray-400 hover:text-white transition">Features</a>
                <a href="#services" onclick="closeMobileMenu()"
                    class="block px-4 py-3 text-sm text-gray-400 hover:text-white transition">Services</a>
                <a href="#feedback" onclick="closeMobileMenu()"
                    class="block px-4 py-3 text-sm text-gray-400 hover:text-white transition">Feedback</a>
                <a href="#contacts" onclick="closeMobileMenu()"
                    class="block px-4 py-3 text-sm text-gray-400 hover:text-white transition">Contact</a>
            </div>
        </nav>

        <div class="p-6 border-t border-white/5">
            <a href="{{ url('/register') }}" onclick="closeMobileMenu()"
                class="block w-full text-center bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3.5 rounded-2xl transition text-sm">
                Get Started Free
            </a>
        </div>
    </div>
    ...
    <section class="relative min-h-screen w-full hero-bg flex flex-col justify-between p-5 sm:p-8 md:p-12 lg:p-16">
        ...
        <div
            class="absolute top-20 right-10 w-72 h-72 bg-blue-500/10 rounded-full blur-[100px] animate-pulse-slow pointer-events-none">
        </div>
        <div class="absolute bottom-40 left-10 w-56 h-56 bg-purple-500/10 rounded-full blur-[80px] animate-pulse-slow pointer-events-none"
            style="animation-delay: 2s;"></div>

        <nav class="flex justify-between items-center w-full relative z-10">
            <div class="flex items-center gap-2.5 sm:gap-3">
                <div
                    class="w-9 h-9 sm:w-10 sm:h-10 bg-blue-600 rounded-xl flex items-center justify-center shadow-lg shadow-blue-600/30">
                    <i class="fa-solid fa-bus text-white text-sm"></i>
                </div>
                <span class="text-lg sm:text-xl md:text-2xl font-bold tracking-tight">Smart<span
            ...
            <button id="hamburgerBtn" onclick="openMobileMenu()"
                class="hamburger md:hidden w-10 h-10 rounded-full bg-white/10 backdrop-blur-md border border-white/10 flex flex-col items-center justify-center gap-1.5">
        ...
        <div class="max-w-5xl relative z-10 pt-8 md:pt-0">
            <h1
                class="hero-load-2 text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-extrabold leading-[0.95] sm:leading-[1] mb-6 sm:mb-8 tracking-tight">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-6 relative z-10">
            <a href="{{ url('/register') }}"
                ...
                <div
                    class="bg-white text-black w-10 h-10 sm:w-12 sm:h-12 rounded-full flex items-center justify-center group-hover:bg-blue-600 group-hover:text-white transition-all duration-500">
        ...
        <!-- Scroll indicator -->
        <div
            class="absolute bottom-6 left-1/2 -translate-x-1/2 hidden md:flex flex-col items-center gap-2 hero-load-4">
    ...
    <div class="bg-[#0a0a0a] border-y border-white/5 py-4 overflow-hidden">
        <div class="flex animate-marquee whitespace-nowrap">
            <span class="mx-8 text-xs uppercase tracking-[0.3em] text-gray-600 font-medium flex items-center gap-3"><i
                    class="fa-solid fa-circle text-[3px] text-blue-500"></i> Real-Time GPS Tracking</span>
            <span class="mx-8 text-xs uppercase tracking-[0.3em] text-gray-600 font-medium flex items-center gap-3"><i
    ...
    <section id="features" class="py-16 sm:py-24 md:py-32 px-5 sm:px-8 bg-[#050505]">
        <div class="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
            ...
            <div class="lg:w-1/2 relative w-full reveal">
                <div
                    class="absolute -inset-6 bg-gradient-to-br from-blue-600/20 to-purple-600/10 rounded-[3rem] blur-[60px]">
                </div>
                ...
                <div class="relative">
                    ...
                    <!-- Floating stat card -->
                    <div
                        class="absolute -bottom-4 -right-4 sm:bottom-6 sm:right-6 glass-card glow-blue p-4 sm:p-5 rounded-2xl animate-float">
                    ...
                    <!-- Floating badge -->
                    <div class="absolute -top-3 -left-3 sm:top-6 sm:left-6 glass-card p-3 sm:p-4 rounded-2xl animate-float"
            ...
            <div class="lg:w-1/2 space-y-6 sm:space-y-8">
                <div class="space-y-4 reveal">
                    <div class="inline-flex items-center gap-2 bg-blue-500/10 px-3 py-1.5 rounded-full">
                        ...
                        <span
                            class="text-blue-400 text-[10px] font-bold uppercase tracking-[0.2em]">SmartCommute</span>
                    </div>
                    <h2
                        class="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold leading-[1.05] tracking-tight">
                        Your Commute <br>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5">
                    <div class="glass-card p-5 sm:p-6 rounded-2xl reveal reveal-delay-1 group cursor-default">
                        <div
                            class="w-10 h-10 bg-blue-500/10 rounded-xl flex items-center justify-center mb-4 group-hover:bg-blue-600/20 group-hover:scale-110 transition-all duration-500">
                            <i class="fa-solid fa-chart-line text-blue-400"></i>
                        </div>
                        <h4 class="font-bold mb-2 text-sm sm:text-base">Data-Driven</h4>
                        <p class="text-[11px] sm:text-xs text-gray-500 leading-relaxed">Optimization based on thousands
                            of daily commute patterns.</p>
                    </div>

                    <div class="glass-card p-5 sm:p-6 rounded-2xl reveal reveal-delay-2 group cursor-default">
                        <div
                            class="w-10 h-10 bg-green-500/10 rounded-xl flex items-center justify-center mb-4 group-hover:bg-green-600/20 group-hover:scale-110 transition-all duration-500">
                    ...
                    <div class="glass-card p-5 sm:p-6 rounded-2xl reveal reveal-delay-3 group cursor-default">
                        ...
                        <p class="text-[11px] sm:text-xs text-gray-500 leading-relaxed">End-to-end encrypted payments
                            and private data handling.</p>
                    </div>

                    <div class="glass-card p-5 sm:p-6 rounded-2xl reveal reveal-delay-4 group cursor-default">
                        <div
                            class="w-10 h-10 bg-orange-500/10 rounded-xl flex items-center justify-center mb-4 group-hover:bg-orange-600/20 group-hover:scale-110 transition-all duration-500">
                            <i class="fa-solid fa-leaf text-orange-400"></i>
                        </div>
                        <h4 class="font-bold mb-2 text-sm sm:text-base">Eco-Friendly</h4>
                        <p class="text-[11px] sm:text-xs text-gray-500 leading-relaxed">Reduced carbon footprint
                            through optimized route planning.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section id="services" class="py-16 sm:py-24 md:py-32 px-5 sm:px-8 bg-[#050505] relative overflow-hidden">
        <div
            class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[400px] bg-blue-600/5 blur-[120px] rounded-full pointer-events-none">
        </div>
        ...
        <div class="max-w-7xl mx-auto relative z-10">
            <div class="text-center mb-12 sm:mb-16 space-y-4 reveal">
                <div class="inline-flex items-center gap-2 bg-blue-500/10 px-3 py-1.5 rounded-full">
                    <span class="w-1.5 h-1.5 bg-blue-400 rounded-full"></span>
                    <span class="text-blue-400 text-[10px] font-bold uppercase tracking-[0.2em]">SmartCommute
                        System</span>
                </div>
                ...
                <p class="text-gray-500 max-w-2xl mx-auto text-xs sm:text-sm px-4">Everything you need to navigate your
                    daily journey with precision and ease.</p>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5">
                ...
                <div
                    ...
                    <div
                        class="w-12 h-12 sm:w-14 sm:h-14 bg-blue-500/10 rounded-2xl flex items-center justify-center mb-5 sm:mb-6 group-hover:scale-110 group-hover:bg-blue-500/20 transition-all duration-500">
                ...
                <div
                    ...
                    <div
                        class="w-12 h-12 sm:w-14 sm:h-14 bg-green-500/10 rounded-2xl flex items-center justify-center mb-5 sm:mb-6 group-hover:scale-110 group-hover:bg-green-500/20 transition-all duration-500">
    ...
    <section id="feedback" class="py-16 sm:py-24 md:py-32 px-5 sm:px-8 bg-[#050505] relative">
        ...
        <div class="max-w-7xl mx-auto relative z-10">
            <div class="text-center mb-12 sm:mb-16 space-y-4 reveal">
                ...
                <p class="text-gray-500 max-w-2xl mx-auto text-xs sm:text-sm px-4">See how SmartCommute is changing the
                    daily journey for thousands of people.</p>
            </div>

            <div class="grid grid-cols-1 md:grid-cols-3 gap-5 sm:gap-6">

                <div
                    class="testimonial-card glass-card p-7 sm:p-10 rounded-[2rem] flex flex-col items-center text-center relative group reveal reveal-delay-1">
                    <div
                        class="w-14 h-14 sm:w-16 sm:h-16 rounded-full bg-gradient-to-br from-blue-500/20 to-blue-600/5 border border-blue-500/20 flex items-center justify-center mb-5 group-hover:border-blue-500/50 group-hover:scale-105 transition-all duration-500">
                    ...
                    <div class="mt-auto">
                        ...
                        <p class="text-[9px] sm:text-[10px] uppercase tracking-widest text-blue-400 font-bold mt-1">
                            Daily Commuter</p>
                    </div>
                </div>

                <div
                    class="testimonial-card glass-card p-7 sm:p-10 rounded-[2rem] flex flex-col items-center text-center relative group border-blue-500/15 glow-blue reveal reveal-delay-2">
                    ...
                    <div
                        class="w-14 h-14 sm:w-16 sm:h-16 rounded-full bg-gradient-to-br from-purple-500/20 to-purple-600/5 border border-purple-500/20 flex items-center justify-center mb-5 group-hover:border-purple-500/50 group-hover:scale-105 transition-all duration-500">
                    ...
                    <div class="mt-auto">
                        ...
                        <p class="text-[9px] sm:text-[10px] uppercase tracking-widest text-purple-400 font-bold mt-1">
                            Transit Driver</p>
                    </div>
                </div>

                <div
                    class="testimonial-card glass-card p-7 sm:p-10 rounded-[2rem] flex flex-col items-center text-center relative group reveal reveal-delay-3">
                    <div
                        class="w-14 h-14 sm:w-16 sm:h-16 rounded-full bg-gradient-to-br from-green-500/20 to-green-600/5 border border-green-500/20 flex items-center justify-center mb-5 group-hover:border-green-500/50 group-hover:scale-105 transition-all duration-500">
                    ...
                    <div class="mt-auto">
                        ...
                        <p class="text-[9px] sm:text-[10px] uppercase tracking-widest text-green-400 font-bold mt-1">
                            Fleet Manager</p>
                    </div>
                </div>
    ...
    <section id="contacts" class="py-16 sm:py-24 md:py-32 px-5 sm:px-8 bg-[#050505] relative">
        ...
        <div class="absolute bottom-1/3 right-0 w-96 h-96 bg-blue-600/5 blur-[120px] rounded-full pointer-events-none">
        </div>
                ...
                <div class="space-y-6 sm:space-y-8 reveal">
                    <div>
                        <div class="inline-flex items-center gap-2 bg-blue-500/10 px-3 py-1.5 rounded-full mb-6">
                            <span class="w-1.5 h-1.5 bg-blue-400 rounded-full"></span>
                            <span class="text-blue-400 text-[10px] font-bold uppercase tracking-[0.2em]">Contact
                                Us</span>
                        </div>
                        <h2
                            class="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold leading-[1.05] tracking-tight mb-4">
                    ...
                    <div class="space-y-5">
                        <div class="flex items-center gap-4 group">
                            <div
                                class="w-12 h-12 bg-white/5 border border-white/10 rounded-2xl flex items-center justify-center text-lg group-hover:bg-blue-500/10 group-hover:border-blue-500/30 transition-all duration-300 shrink-0">
                        ...
                        <div class="flex items-center gap-4 group">
                            <div
                                class="w-12 h-12 bg-white/5 border border-white/10 rounded-2xl flex items-center justify-center text-lg group-hover:bg-green-500/10 group-hover:border-green-500/30 transition-all duration-300 shrink-0">
                        ...
                        <div class="flex items-center gap-4 group">
                            <div
                                class="w-12 h-12 bg-white/5 border border-white/10 rounded-2xl flex items-center justify-center text-lg group-hover:bg-purple-500/10 group-hover:border-purple-500/30 transition-all duration-300 shrink-0">
                ...
                <div class="glass-card p-6 sm:p-8 md:p-10 rounded-[1.5rem] sm:rounded-[2rem] reveal reveal-delay-2">
                    <form action="#" class="space-y-4 sm:space-y-5">
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div class="space-y-2">
                                <label
                                    class="text-[10px] uppercase tracking-widest text-gray-500 ml-1 font-medium">First
                                    Name</label>
                            ...
                            <div class="space-y-2">
                                <label
                                    class="text-[10px] uppercase tracking-widest text-gray-500 ml-1 font-medium">Last
                                    Name</label>
                        ...
                        <div class="space-y-2">
                            <label
                                class="text-[10px] uppercase tracking-widest text-gray-500 ml-1 font-medium">Email</label>
                        ...
                        <div class="space-y-2">
                            <label
                                class="text-[10px] uppercase tracking-widest text-gray-500 ml-1 font-medium">Message</label>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 sm:gap-12 mb-12 sm:mb-16">
                ...
                <div class="space-y-5 sm:space-y-6 sm:col-span-2 lg:col-span-1">
                    <div class="flex items-center space-x-2">
                        ...
                        <span class="text-lg font-bold tracking-tight">Smart<span
                                class="text-blue-400">Commute</span></span>
                    </div>
                    ...
                    <div class="flex space-x-3">
                        <a href="#"
                            class="w-9 h-9 glass-card rounded-xl flex items-center justify-center hover:bg-blue-600 hover:border-blue-600 transition-all duration-300 group">
                            <i
                                class="fa-brands fa-facebook-f text-xs text-gray-400 group-hover:text-white transition"></i>
                        </a>
                        <a href="#"
                            class="w-9 h-9 glass-card rounded-xl flex items-center justify-center hover:bg-blue-600 hover:border-blue-600 transition-all duration-300 group">
                            <i
                                class="fa-brands fa-twitter text-xs text-gray-400 group-hover:text-white transition"></i>
                        </a>
                        <a href="#"
                            class="w-9 h-9 glass-card rounded-xl flex items-center justify-center hover:bg-blue-600 hover:border-blue-600 transition-all duration-300 group">
                            <i
                                class="fa-brands fa-instagram text-xs text-gray-400 group-hover:text-white transition"></i>
                        </a>
                        <a href="#"
                            class="w-9 h-9 glass-card rounded-xl flex items-center justify-center hover:bg-blue-600 hover:border-blue-600 transition-all duration-300 group">
                ...
                <div>
                    <h4 class="text-white font-bold mb-5 sm:mb-6 uppercase text-[10px] tracking-[0.2em]">Quick Links
                    </h4>
                    <ul class="space-y-3 sm:space-y-4 text-xs sm:text-sm text-gray-500">
                        <li><a href="#services"
                                class="hover:text-blue-400 transition flex items-center gap-2 group"><i
                                    class="fa-solid fa-chevron-right text-[6px] text-gray-700 group-hover:text-blue-400 transition"></i>
                                Our Services</a></li>
                        <li><a href="#features"
                                class="hover:text-blue-400 transition flex items-center gap-2 group"><i
                                    class="fa-solid fa-chevron-right text-[6px] text-gray-700 group-hover:text-blue-400 transition"></i>
                ...
                <div>
                    ...
                    <ul class="space-y-3 sm:space-y-4 text-xs sm:text-sm text-gray-500">
                        <li><a href="#" class="hover:text-blue-400 transition flex items-center gap-2 group"><i
                                    class="fa-solid fa-chevron-right text-[6px] text-gray-700 group-hover:text-blue-400 transition"></i>
                                Help Center</a></li>
                        <li><a href="#" class="hover:text-blue-400 transition flex items-center gap-2 group"><i
                                    class="fa-solid fa-chevron-right text-[6px] text-gray-700 group-hover:text-blue-400 transition"></i>
                ...
                <div class="space-y-4 sm:space-y-6">
                    ...
                    <p class="text-gray-500 text-xs sm:text-sm">Get the latest route updates and news delivered to your
                        inbox.</p>
                    <div class="relative">
                        ...
                        <button
                            class="absolute right-1.5 top-1/2 -translate-y-1/2 bg-blue-600 text-white p-2.5 rounded-lg hover:bg-blue-700 transition-all duration-300 hover:scale-105">
            ...
            <div class="flex flex-col sm:flex-row justify-between items-center gap-4">
                ...
                <div class="flex items-center gap-5 sm:gap-6">
                    <span class="text-[10px] text-gray-600 uppercase tracking-widest flex items-center">
                        <span class="w-1.5 h-1.5 bg-green-500 rounded-full mr-2 animate-pulse"></span> Servers
                        Operational
                    </span>
                </div>
            </div>
