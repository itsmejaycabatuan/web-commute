...
<body class="antialiased font-sans text-white">
    ...
    <div class="hidden md:flex items-center space-x-8 text-sm font-medium bg-white/10 backdrop-blur-md border border-white/20 px-8 py-3 rounded-full">
       <a href="{{ url('/register') }}" class="hover:text-gray-300 transition">Register</a>
        ...
        <div class="flex flex-col md:flex-row justify-between items-end md:items-center space-y-6 md:space-y-0">
            ...
            <a href="/services" class="group flex items-center space-x-4 border border-white/50 rounded-full px-2 py-2 pr-6 hover:bg-white hover:text-black transition duration-300">
        ...
        <div class="lg:w-1/2 space-y-8">
            <div class="space-y-4">
                ...
                <p class="text-gray-400 text-lg leading-relaxed max-w-xl">
                    We believe in the power of real-time data. Our analytics-driven approach allows us to make informed decisions and optimize your commute for maximum efficiency.
                </p>
            </div>

            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="glass p-6 rounded-2xl border-white/5 hover:border-blue-500/30 transition group">
                    <div class="w-10 h-10 bg-white/5 rounded-lg flex items-center justify-center mb-4 group-hover:bg-blue-600/20 transition">
                        <i class="fa-solid fa-chart-line text-blue-400"></i>
                    </div>
                    <h4 class="font-bold mb-2">Data-Driven</h4>
                    <p class="text-xs text-gray-500 leading-relaxed">Optimization based on thousands of daily commute patterns.</p>
                </div>

                <div class="glass p-6 rounded-2xl border-white/5 hover:border-green-500/30 transition group">
                    <div class="w-10 h-10 bg-white/5 rounded-lg flex items-center justify-center mb-4 group-hover:bg-green-600/20 transition">
                        <i class="fa-solid fa-bolt text-green-400"></i>
                    </div>
                    <h4 class="font-bold mb-2">Real-Time</h4>
                    <p class="text-xs text-gray-500 leading-relaxed">Instant updates on bus locations and traffic delays.</p>
                </div>
            </div>
  ...
  <section id="services" class="py-24 px-8 bg-[#0a0a0a] relative overflow-hidden">
    <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[300px] bg-blue-600/10 blur-[120px] rounded-full"></div>

    <div class="max-w-7xl mx-auto relative z-10">
        <div class="text-center mb-16 space-y-4">
            <span class="text-blue-400 text-xs font-black uppercase tracking-[0.3em]">SmartCommute System</span>
            <h2 class="text-4xl md:text-5xl font-bold">Comprehensive Commute <span class="text-white/40">Solutions</span></h2>
            <p class="text-gray-500 max-w-2xl mx-auto text-sm">Everything you need to navigate your daily journey with precision and ease.</p>
        </div>

        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">

            <div class="glass glass-inset p-8 rounded-[2rem] hover:bg-white/5 transition duration-500 group border-white/5">
                <div class="w-14 h-14 bg-blue-500/10 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition duration-500">
                    <i class="fa-solid fa-location-crosshairs text-blue-400 text-xl"></i>
                </div>
                <h4 class="text-lg font-bold mb-3">Live GPS Tracking</h4>
                <p class="text-xs text-gray-500 leading-relaxed mb-6">Track your bus in real-time with meter-perfect precision. Never miss a ride or wait in the rain again.</p>
                <a href="#" class="text-[10px] font-black uppercase tracking-widest text-blue-400 hover:text-white transition">Live Update Enable</a>
            </div>

            <div class="glass glass-inset p-8 rounded-[2rem] hover:bg-white/5 transition duration-500 group border-white/5">
                <div class="w-14 h-14 bg-purple-500/10 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition duration-500">
                    <i class="fa-solid fa-calendar-check text-purple-400 text-xl"></i>
                </div>
                <h4 class="text-lg font-bold mb-3">Smart Scheduling</h4>
                <p class="text-xs text-gray-500 leading-relaxed mb-6">AI-driven route planning that learns your habits and suggests the fastest departure times automatically.</p>
                <a href="#" class="text-[10px] font-black uppercase tracking-widest text-purple-400 hover:text-white transition">Optimized Speed</a>
            </div>

            <div class="glass glass-inset p-8 rounded-[2rem] hover:bg-white/5 transition duration-500 group border-white/5">
                <div class="w-14 h-14 bg-green-500/10 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition duration-500">
                    <i class="fa-solid fa-credit-card text-green-400 text-xl"></i>
                </div>
                <h4 class="text-lg font-bold mb-3">Contactless Pay</h4>
                <p class="text-xs text-gray-500 leading-relaxed mb-6">Swift, secure, and cash-free. Manage your digital wallet and pay for rides with a single tap or scan.</p>
                <a href="#" class="text-[10px] font-black uppercase tracking-widest text-green-400 hover:text-white transition">More Efficiency</a>
            </div>

            <div class="glass glass-inset p-8 rounded-[2rem] hover:bg-white/5 transition duration-500 group border-white/5">
                <div class="w-14 h-14 bg-orange-500/10 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition duration-500">
                    <i class="fa-solid fa-route text-orange-400 text-xl"></i>
                </div>
                <h4 class="text-lg font-bold mb-3">Route Analytics</h4>
                <p class="text-xs text-gray-500 leading-relaxed mb-6">Advanced heatmaps and traffic data help us optimize city-wide routes to reduce your travel time.</p>
                <a href="#" class="text-[10px] font-black uppercase tracking-widest text-orange-400 hover:text-white transition">High Efficiency</a>
            </div>
  ...
  <section id="feedback" class="py-24 px-8 bg-[#0a0a0a] relative">
    <div class="max-w-7xl mx-auto relative z-10">
        ...
        <div class="text-center mb-16 space-y-4">
            ...
            <p class="text-gray-500 max-w-2xl mx-auto text-sm">See how SmartCommute is changing the daily journey for thousands of people.</p>
        </div>

        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">

            <div class="glass glass-inset p-10 rounded-[2.5rem] flex flex-col items-center text-center relative group">
               <div class="w-16 h-16 rounded-full border-2 border-blue-500/30 p-1 mb-6 group-hover:border-blue-500 transition duration-500 flex items-center justify-center">
    <i class="fa-solid fa-user text-2xl text-blue-400"></i>
            ...
            <div class="glass glass-inset p-10 rounded-[2.5rem] flex flex-col items-center text-center relative group border-blue-500/20 shadow-2xl shadow-blue-500/5">
               <div class="w-16 h-16 rounded-full border-2 border-blue-500/30 p-1 mb-6 group-hover:border-blue-500 transition duration-500 flex items-center justify-center">
    <i class="fa-solid fa-user text-2xl text-blue-400"></i>
</div>
    ...
    <div class="max-w-6xl w-full grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div class="space-y-8">
            <div>
                ...
                <p class="text-gray-400 max-w-md">Have questions about our routes or pricing? Our team is here to help you optimize your commute.</p>
            </div>
            ...
            <form action="#" class="space-y-5">
                <div class="grid grid-cols-2 gap-4">
                    <div class="space-y-2">
                        ...
                        <input type="text" placeholder="" class="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-white/20">
                    </div>
                    <div class="space-y-2">
                ...
                <div class="space-y-2">
                    ...
                    <textarea rows="4" placeholder="How can we help?" class="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-white/20"></textarea>
                </div>

                <button class="w-full bg-white text-black font-bold py-4 rounded-xl hover:bg-gray-200 transition transform active:scale-95 uppercase tracking-widest text-xs">
                    Send Message
                </button>
            </form>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
            ...
            <div class="space-y-6">
                <div class="flex items-center space-x-2">
                    ...
                    <span class="text-xl font-bold tracking-tighter">Smart<span class="text-blue-500">Commute</span></span>
                </div>
                <p class="text-gray-500 text-sm leading-relaxed">
                    Revolutionizing the way you move. Real-time tracking, smart scheduling, and secure payments all in one place.
                </p>
                <div class="flex space-x-4">
                    <a href="#" class="w-9 h-9 glass rounded-full flex items-center justify-center hover:bg-blue-600 transition duration-300">
            ...
            <div class="space-y-6">
                ...
                <div class="relative">
                    <input type="email" placeholder="Your email" class="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-xs focus:outline-none focus:ring-1 focus:ring-blue-500 transition">
                    <button class="absolute right-2 top-1/2 -translate-y-1/2 bg-blue-600 text-white p-2 rounded-lg hover:bg-blue-700 transition">
        ...
        <div class="pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div class="flex items-center space-x-6">
                <span class="text-[10px] text-gray-600 uppercase tracking-widest flex items-center">
                    <i class="fa-solid fa-circle text-[6px] text-green-500 mr-2 animate-pulse"></i> Servers Operational
                </span>
            </div>
        </div>
    </div>
