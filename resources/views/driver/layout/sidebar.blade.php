    ...
    <div class="bg-[#0a0a0a]/95 backdrop-blur-xl border-t border-[#1a1a1a] px-2 pb-[env(safe-area-inset-bottom)]">
        <div class="flex items-center justify-around py-1.5">
            ...
            <a href="{{ route('driver.timekeeping') }}"
                class="flex flex-col items-center gap-0.5 py-1.5 px-3 rounded-xl transition-all active:scale-90 {{ request()->routeIs('driver.timekeeping') ? 'text-blue-400' : 'text-[#444]' }}">
...
<div id="mobile-drawer"
    ...
    <nav class="flex-1 p-3 space-y-1 overflow-y-auto">
        ...
        <a href="{{ route('driver.timekeeping') }}"
            class="flex items-center gap-3 px-3 py-2.5 rounded-xl transition-all border {{ request()->routeIs('driver.timekeeping') ? 'bg-blue-500/[0.06] text-blue-400 border-blue-500/15' : 'text-[#555] border-transparent hover:bg-[#111] hover:text-[#888]' }}">
            <div class="w-7 h-7 rounded-lg {{ request()->routeIs('driver.timekeeping') ? 'bg-blue-500/10' : 'bg-[#111]' }} flex items-center justify-center shrink-0">
...
<aside :class="open ? 'w-[270px] p-3' : 'w-[76px] p-2'"
    ...
    <div>
        ...
        <nav class="space-y-1">
            ...
            <a href="{{ route('driver.timekeeping') }}"
                :class="open ? 'gap-3 px-3' : 'justify-center px-0'"
                class="flex items-center py-2.5 rounded-xl transition-all border group {{ request()->routeIs('driver.timekeeping') ? 'bg-blue-500/[0.06] text-blue-400 border-blue-500/15' : 'text-[#555] border-transparent hover:bg-[#111] hover:text-[#888] hover:border-[#1a1a1a]' }}">
                <div class="w-8 h-8 rounded-lg {{ request()->routeIs('driver.timekeeping') ? 'bg-blue-500/10' : 'bg-[#111] group-hover:bg-[#161616]' }} flex items-center justify-center shrink-0 transition">
