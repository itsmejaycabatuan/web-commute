...
<head>
    ...
    <style>
        ...
        /* ═══ LOGOUT MODAL BG/BORDER CATCHES ═══ */
            ...
            <div class="lg:hidden mb-5">
                <div class="glass-card p-4 rounded-[1.25rem]">
                    <div class="flex items-center gap-3.5">
                        ...
                        <div class="min-w-0">
                            <h2 class="text-sm font-bold truncate">{{ $driver->name ?? 'Driver' }}</h2>
            ...
            <div class="grid grid-cols-2 xl:grid-cols-3 gap-3 sm:gap-4 mb-5 sm:mb-6">
                ...
                <div class="glass-card p-4 sm:p-5 rounded-[1.25rem] border-l-2 border-l-blue-500">
                    <div class="flex items-center gap-2 mb-2 sm:mb-3">
                        ...
                        <span
                            class="text-[7px] sm:text-[8px] font-bold uppercase tracking-[0.15em] text-[#444]">Distance
                            Today</span>
                    </div>
                    <div class="flex items-baseline gap-1 sm:gap-1.5">
                        <span
                            class="text-2xl sm:text-3xl font-black tracking-tight">{{ number_format($total_distance, 1) }}</span>
                ...
                <div class="glass-card p-4 sm:p-5 rounded-[1.25rem] border-l-2 border-l-emerald-500">
                    <div class="flex items-center gap-2 mb-2 sm:mb-3">
                        ...
                        <span class="text-[7px] sm:text-[8px] font-bold uppercase tracking-[0.15em] text-[#444]">Hours
                            Today</span>
                    </div>
                    <div class="flex items-baseline gap-1 sm:gap-1.5">
                        <span
                            class="text-2xl sm:text-3xl font-black tracking-tight">{{ $todayRecord->hours_worked ?? '0.0' }}</span>
                ...
                <div class="glass-card p-4 sm:p-5 rounded-[1.25rem] border-l-2 border-l-amber-500">
                    <div class="flex items-center gap-2 mb-2 sm:mb-3">
                        ...
                        <span class="text-[7px] sm:text-[8px] font-bold uppercase tracking-[0.15em] text-[#444]">OT This
                            Week</span>
                    </div>
                    <div class="flex items-baseline gap-1 sm:gap-1.5">
                        <span
                            class="text-2xl sm:text-3xl font-black tracking-tight">{{ number_format($weekOvertime ?? 0, 1) }}</span>
                ...
                <div class="glass-card p-4 sm:p-5 rounded-[1.25rem] border-l-2 border-l-purple-500">
                    ...
                    <div class="flex items-baseline gap-1 sm:gap-1.5">
                        <span
                            class="text-2xl sm:text-3xl font-black tracking-tight">{{ number_format($weekHours ?? 0, 1) }}</span>
                ...
                <div class="glass-card p-4 sm:p-5 rounded-[1.25rem] border-l-2 border-l-red-500">
                    <div class="flex items-center gap-2 mb-2 sm:mb-3">
                        ...
                        <span
                            class="text-[7px] sm:text-[8px] font-bold uppercase tracking-[0.15em] text-[#444]">Violations</span>
                    </div>
                    <div class="flex items-baseline gap-1 sm:gap-1.5">
                ...
                <div class="glass-card p-4 sm:p-5 rounded-[1.25rem] border-l-2 border-l-rose-500">
                    <div class="flex items-center gap-2 mb-2 sm:mb-3">
                        ...
                        <span
                            class="text-[7px] sm:text-[8px] font-bold uppercase tracking-[0.15em] text-[#444]">Violation
                            Fines</span>
                    </div>
                    <span
                        class="text-xl sm:text-2xl font-black tracking-tight">₱{{ number_format($totalViolationFines, 0) }}</span>
                </div>
                    ...
                    <div class="glass-card p-4 sm:p-6 rounded-[1.25rem] sm:rounded-[1.5rem]">
                        <div class="flex items-center justify-between mb-4 sm:mb-5">
                            <div class="flex items-center gap-2.5">
                                ...
                                <span
                                    class="text-[8px] sm:text-[9px] font-bold uppercase tracking-[0.15em] text-[#555]">Today's
                                    Shift</span>
                            </div>
                            @if ($todayRecord)
                                <span
                                    class="text-[8px] bg-emerald-500/10 text-emerald-400 border border-emerald-500/15 px-2 py-0.5 rounded-md font-bold uppercase">Active</span>
                            @else
                                <span
                                    class="text-[8px] bg-[#111] text-[#444] border border-[#1e1e1e] px-2 py-0.5 rounded-md font-bold uppercase">Not
                                    Started</span>
                            @endif
                        </div>
                        ...
                        @if ($todayRecord)
                            <div class="grid grid-cols-2 sm:grid-cols-3 gap-2 sm:gap-3">
                                <div class="p-3 sm:p-3.5 rounded-xl bg-[#111] border border-[#1e1e1e]">
                                    <p
                                        class="text-[7px] sm:text-[8px] font-bold uppercase tracking-[0.15em] text-[#444] mb-0.5">
                                        Time In</p>
                                    <p class="text-sm sm:text-lg font-black">
                                ...
                                <div
                                    class="p-3 sm:p-3.5 rounded-xl bg-[#111] border border-[#1e1e1e] col-span-2 sm:col-span-1">
                                    <p
                                        class="text-[7px] sm:text-[8px] font-bold uppercase tracking-[0.15em] text-[#444] mb-0.5">
                                        Hours Worked</p>
                                    <div class="flex items-baseline gap-1 sm:gap-1.5">
                        ...
                        @else
                            <div class="text-center py-6 sm:py-8">
                                <div
                                    class="w-12 h-12 rounded-xl bg-[#111] border border-[#1e1e1e] flex items-center justify-center mx-auto mb-3">
                        ...
                        <div class="p-4 sm:p-6 pb-0">
                            <div class="flex items-center justify-between mb-4 sm:mb-5">
                                <div class="flex items-center gap-2.5">
                                    ...
                                    <span
                                        class="text-[8px] sm:text-[9px] font-bold uppercase tracking-[0.15em] text-[#555]">Timekeeping</span>
                                </div>
                                    ...
                                    @forelse($recentTimeKeeping as $record)
                                        <tr class="table-row">
                                            <td class="px-4 sm:px-6 py-3">
                                                <p class="text-[10px] sm:text-[11px] font-bold text-[#ccc]">
                                            ...
                                            <td class="px-4 sm:px-6 py-3">
                                                <span
                                                    class="text-[10px] sm:text-[11px] font-bold text-[#888]">{{ $record->time_in ? \Carbon\Carbon::parse($record->time_in)->format('h:i A') : '—' }}</span>
                                            </td>
                                            <td class="px-4 sm:px-6 py-3">
                                                <span
                                                    class="text-[10px] sm:text-[11px] font-bold text-[#888]">{{ $record->time_out ? \Carbon\Carbon::parse($record->time_out)->format('h:i A') : '—' }}</span>
                                            </td>
                                            <td class="px-4 sm:px-6 py-3">
                                                <span
                                                    class="text-[10px] sm:text-[11px] font-bold">{{ $record->hours_worked ?? '0.0' }}</span>
                                            </td>
                                            <td class="px-4 sm:px-6 py-3">
                                                @if ($record->overtime_hours && $record->overtime_hours > 0)
                                                    <span
                                                        class="text-[9px] sm:text-[10px] font-bold text-amber-400">+{{ number_format($record->overtime_hours, 1) }}</span>
                                                @else
                                            ...
                                            <td class="px-4 sm:px-6 py-3">
                                                @if ($record->sick)
                                                    <span
                                                        class="text-[7px] sm:text-[8px] bg-amber-500/10 text-amber-400 border border-amber-500/15 px-1.5 py-0.5 rounded-md font-bold uppercase">Sick</span>
                                                @elseif($record->vacation)
                                                    <span
                                                        class="text-[7px] sm:text-[8px] bg-blue-500/10 text-blue-400 border border-blue-500/15 px-1.5 py-0.5 rounded-md font-bold uppercase">Vacation</span>
                                                @elseif($record->time_in && $record->time_out)
                                                    <span
                                                        class="text-[7px] sm:text-[8px] bg-emerald-500/10 text-emerald-400 border border-emerald-500/15 px-1.5 py-0.5 rounded-md font-bold uppercase">Complete</span>
                                                @elseif($record->time_in)
                                                    <span
                                                        class="text-[7px] sm:text-[8px] bg-blue-500/10 text-blue-400 border border-blue-500/15 px-1.5 py-0.5 rounded-md font-bold uppercase">In
                                                        Progress</span>
                                                @else
                                                    <span
                                                        class="text-[7px] sm:text-[8px] bg-[#111] text-[#444] border border-[#1e1e1e] px-1.5 py-0.5 rounded-md font-bold uppercase">Absent</span>
                                                @endif
                                            </td>
                                        </tr>
                                    @empty
                                        <tr>
                                            <td colspan="6" class="py-10 sm:py-12">
                                                <div class="flex flex-col items-center justify-center">
                                                    ...
                                                    <p class="text-[10px] sm:text-[11px] text-[#444] font-medium">No
                                                        records yet</p>
                                                </div>
                                            </td>
                                        </tr>
                ...
                <div class="xl:col-span-4 flex flex-col gap-5 sm:gap-6">
                    ...
                    @if ($vehicle)
                        <div class="glass-card p-4 sm:p-6 rounded-[1.25rem] sm:rounded-[1.5rem]">
                            <div class="flex items-center gap-2.5 mb-4 sm:mb-5">
                                ...
                                <span
                                    class="text-[8px] sm:text-[9px] font-bold uppercase tracking-[0.15em] text-[#555]">Assigned
                                    Vehicle</span>
                            </div>

                            <div class="space-y-2.5">
                                <div
                                    class="flex items-center gap-3 p-3 sm:p-3.5 rounded-xl bg-[#111] border border-[#1e1e1e]">
                                    <div
                                    ...
                                    <div class="min-w-0">
                                        <p class="text-[11px] sm:text-[12px] font-bold truncate">{{ $vehicle->year }}
                                            {{ $vehicle->brand }} {{ $vehicle->model }}</p>
                                        <p class="text-[8px] sm:text-[9px] text-[#444] font-mono uppercase">
                                ...
                                <div class="grid grid-cols-2 gap-2">
                                    <div class="p-2.5 sm:p-3 rounded-xl bg-[#111] border border-[#1e1e1e]">
                                        <p
                                            class="text-[7px] sm:text-[8px] font-bold uppercase tracking-[0.15em] text-[#444] mb-0.5">
                                            Fuel Type</p>
                                        <p class="text-[10px] sm:text-[11px] font-bold text-[#888] capitalize">
                                            {{ $vehicle->fuel_type }}</p>
                                    </div>
                                    <div class="p-2.5 sm:p-3 rounded-xl bg-[#111] border border-[#1e1e1e]">
                                        <p
                                            class="text-[7px] sm:text-[8px] font-bold uppercase tracking-[0.15em] text-[#444] mb-0.5">
                                            Tank Cap.</p>
                                        <p class="text-[10px] sm:text-[11px] font-bold text-[#888]">
                                ...
                                <div class="pt-2.5 sm:pt-3 border-t border-[#1e1e1e] space-y-2 sm:space-y-2.5">
                                    <div class="flex items-center justify-between">
                                        <span
                                            class="text-[8px] sm:text-[9px] font-bold uppercase tracking-[0.15em] text-[#444]">Status</span>
                                        @if ($vehicle->status === 'active')
                                            <span
                                                class="text-[8px] sm:text-[9px] font-bold text-emerald-400 flex items-center gap-1.5">
                                                <i class="fa-solid fa-circle-check text-[7px] sm:text-[8px]"></i>
                                                Active
                                            </span>
                                        @else
                                            <span
                                                class="text-[8px] sm:text-[9px] font-bold text-red-400 flex items-center gap-1.5">
                                    ...
                                    <div class="flex items-center justify-between">
                                        <span
                                            class="text-[8px] sm:text-[9px] font-bold uppercase tracking-[0.15em] text-[#444]">VIN</span>
                                        <span
                                            class="text-[8px] sm:text-[9px] font-mono text-[#555]">{{ $vehicle->vin ?? 'N/A' }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="glass-card p-4 sm:p-6 rounded-[1.25rem] sm:rounded-[1.5rem]">
                        <div class="flex items-center gap-2.5 mb-4 sm:mb-5">
                            ...
                            <span
                                class="text-[8px] sm:text-[9px] font-bold uppercase tracking-[0.15em] text-[#555]">License
                                Info</span>
                        </div>

                        <div class="space-y-2.5">
                            <div
                                class="flex items-center justify-between p-3 sm:p-3.5 rounded-xl bg-[#111] border border-[#1e1e1e]">
                                <div>
                                    <p
                                        class="text-[7px] sm:text-[8px] font-bold uppercase tracking-[0.15em] text-[#444] mb-0.5">
                                        License Number</p>
                                    <p class="text-[10px] sm:text-[11px] font-bold text-[#ccc] font-mono">
                                ...
                                <div
                                    ...
                                    <i
                                        class="fa-solid @if ($driver->license_status === 'approved' || $driver->is_approved) fa-check text-emerald-400 @elseif($driver->is_rejected) fa-xmark text-red-400 @else fa-clock text-amber-400 @endif text-[8px] sm:text-[9px]"></i>
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-2 gap-2">
                                <div class="p-2.5 sm:p-3 rounded-xl bg-[#111] border border-[#1e1e1e]">
                                    <p
                                        class="text-[7px] sm:text-[8px] font-bold uppercase tracking-[0.15em] text-[#444] mb-0.5">
                                        Code</p>
                                    <p class="text-[10px] sm:text-[11px] font-bold text-[#888] font-mono">
                                ...
                                <div class="p-2.5 sm:p-3 rounded-xl bg-[#111] border border-[#1e1e1e]">
                                    <p
                                        ...
                                        Expires</p>
                                    <p
                                        class="text-[10px] sm:text-[11px] font-bold @if ($driver->expiration_date && \Carbon\Carbon::parse($driver->expiration_date)->isPast()) text-red-400 @else text-[#888] @endif">
                            ...
                            @if ($driver->contact_info)
                                <div class="pt-2.5 sm:pt-3 border-t border-[#1e1e1e]">
                                    <div class="flex items-center justify-between">
                                        <span
                                            class="text-[8px] sm:text-[9px] font-bold uppercase tracking-[0.15em] text-[#444]">Contact</span>
                                        <span
                                            class="text-[10px] sm:text-[11px] font-bold text-[#888]">{{ $driver->contact_info }}</span>
                                    </div>
                                </div>
                            @endif
                        </div>
                    ...
                    <div class="glass-card rounded-[1.25rem] sm:rounded-[1.5rem] overflow-hidden"
                        ...
                        <div class="p-4 sm:p-6 pb-0">
                            <div class="flex items-center justify-between mb-4 sm:mb-5">
                                ...
                                <a href="{{ route('driver.violations') }}"
                                    class="text-[8px] sm:text-[9px] font-bold uppercase tracking-widest text-amber-400 hover:text-blue-500 dark:hover:text-white transition flex items-center gap-1.5">
                                    <span>View All</span>
                        ...
                        <div class="overflow-y-auto px-4 sm:px-6 pb-4 sm:pb-6 space-y-2.5" style="max-height: 380px;">
                            <template x-for="v in violations" :key="v.id">
                                <div
                                    class="p-3.5 rounded-xl bg-[#111] border border-[#1e1e1e] flex gap-3.5 items-start group hover:border-amber-500/20 hover:bg-[#141414] transition-all cursor-pointer">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <div class="flex items-center gap-2 mt-1">
                                            ...
                                            <span class="text-[8px] text-[#444] font-medium"
                                    ...
                                    <div class="text-right shrink-0">
                                        ...
                                        <p class="text-[7px] sm:text-[8px] text-[#444] font-medium mt-0.5"
                                            x-text="v.date"></p>
                                    </div>
                                </div>
                            </template>
                        ...
                        <div class="space-y-2">
                            <a
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <span
                                        class="text-[10px] font-bold text-[#888] group-hover:text-white transition">My
                                        Vehicle</span>
                                </div>
                                <i
                            ...
                            <a href="{{ route('driver.timekeeping') }}"
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <span
                                        class="text-[10px] font-bold text-[#888] group-hover:text-white transition">History</span>
                                </div>
                                <i
                                    class="fa-solid fa-chevron-right text-[8px] text-[#333] group-hover:text-[#555] transition"></i>
                            </a>
