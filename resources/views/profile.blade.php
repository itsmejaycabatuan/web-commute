...
<body class="antialiased" x-data=>
    ...
    <div x-data="{ showLogoutModal: false }" @resize.window="if(window.innerWidth >= 768) open = true">
        @include('components.flash')
        <x-layout.sidebar />
        <main :class="$store.sidebar.open ? 'md:ml-72' : 'md:ml-20'"
            class="sidebar-transition pt-4 sm:pt-8 pr-3 sm:pr-8 pb-8 pl-3 sm:pl-8 min-h-screen mb-20 md:mb-12">
            <div class="max-w-3xl mx-auto">
                ...
                <div class="mb-6 sm:mb-8 anim-up">
                    <div class="flex items-center justify-between mb-1.5">
                        <div class="flex items-center gap-2">
                            <span class="text-[9px] font-bold uppercase tracking-[0.15em] text-[#444]">Driver
                                Console</span>
                        </div>
                    </div>
                    <h1 class="text-xl sm:text-2xl md:text-3xl font-black tracking-tight">My <span
                            class="text-blue-400">Profile</span></h1>
                ...
                <div class="glass-card rounded-2xl sm:rounded-[2rem] overflow-hidden mb-4 anim-up anim-d1">
                    ...
                    <div class="h-24 sm:h-28 relative overflow-hidden">
                        <div class="absolute inset-0 bg-gradient-to-br from-blue-600/20 via-blue-500/10 to-transparent">
                        </div>
                    ...
                    <div class="px-5 sm:px-8 pb-6 sm:pb-8 -mt-10 sm:-mt-12 relative z-10">
                        ...
                        <div class="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4">
                            <div class="bg-[#0e0e0e] rounded-xl sm:rounded-2xl p-3 sm:p-4 border border-[#1a1a1a]">
                                <div
                                    class="w-7 h-7 sm:w-8 sm:h-8 rounded-lg bg-[#111] border border-[#1e1e1e] flex items-center justify-center mb-2 sm:mb-2.5">
                                    <i class="fa-solid fa-envelope text-[9px] sm:text-[10px] text-[#555]"></i>
                                </div>
                                <p class="text-[8px] sm:text-[9px] font-bold uppercase tracking-wider text-[#444] mb-1">
                                    Email</p>
                                <p class="text-[10px] sm:text-[11px] font-bold text-[#aaa] break-all leading-tight">
                                    {{ $user->email }}</p>
                            </div>
                            <div class="bg-[#0e0e0e] rounded-xl sm:rounded-2xl p-3 sm:p-4 border border-[#1a1a1a]">
                                <div
                                ...
                                <p class="text-[10px] sm:text-[11px] font-bold text-[#aaa]">
                            ...
                            <div class="bg-[#0e0e0e] rounded-xl sm:rounded-2xl p-3 sm:p-4 border border-[#1a1a1a]">
                                ...
                                <p class="text-[8px] sm:text-[9px] font-bold uppercase tracking-wider text-[#444] mb-1">
                                    Joined</p>
                                <p class="text-[10px] sm:text-[11px] font-bold text-[#aaa]">
                                    {{ $user->created_at->timezone(config('app.timezone'))->format('M j, Y') }}</p>
                            </div>
                            <div class="bg-[#0e0e0e] rounded-xl sm:rounded-2xl p-3 sm:p-4 border border-[#1a1a1a]">
                                <div
                                    class="w-7 h-7 sm:w-8 sm:h-8 rounded-lg bg-[#111] border border-[#1e1e1e] flex items-center justify-center mb-2 sm:mb-2.5">
                ...
                <div class="glass-card rounded-2xl sm:rounded-[2rem] overflow-hidden mb-4 anim-up anim-d3">
                    <!-- Section Header -->
                    <div
                        class="px-5 sm:px-8 pt-5 sm:pt-6 pb-4 sm:pb-5 border-b border-[#1e1e1e] flex items-center justify-between">
                        <div class="flex items-center gap-2.5 sm:gap-3">
                            <div
                                class="w-8 h-8 sm:w-9 sm:h-9 rounded-xl bg-amber-500/10 border border-amber-500/15 flex items-center justify-center">
                                <i class="fa-solid fa-shield text-[10px] sm:text-[11px] text-amber-400"></i>
                            </div>
                            <div>
                                <h3 class="text-xs sm:text-sm font-bold">Security</h3>
                                <p class="text-[8px] sm:text-[9px] text-[#444] font-medium">Change your account password
                                </p>
                            </div>
                        </div>
                        ...
                        <form action="{{ route('profile.update') }}" method="POST" class="space-y-4">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-4">
                                ...
                                <div class="sm:col-span-2">
                                    <label
                                        class="text-[9px] sm:text-[10px] font-bold uppercase tracking-[0.15em] text-[#444] mb-2 block">Current
                                        Password</label>
                                    <div class="relative">
                                        <i
                                            class="fa-solid fa-lock absolute left-3.5 top-1/2 -translate-y-1/2 text-[10px] text-[#333] pointer-events-none"></i>
                                ...
                                <div>
                                    <label
                                        class="text-[9px] sm:text-[10px] font-bold uppercase tracking-[0.15em] text-[#444] mb-2 block">New
                                        Password</label>
                                    <div class="relative">
                                        <i
                                            class="fa-solid fa-key absolute left-3.5 top-1/2 -translate-y-1/2 text-[10px] text-[#333] pointer-events-none"></i>
                                        <input type="password" name="password" autocomplete="new-password"
                                            class="pw-input" placeholder="New password">
                                    </div>
                                    @error('password')
                                        <p class="text-red-400 text-[10px] mt-1.5 flex items-center gap-1.5">
                                            <i class="fa-solid fa-circle-exclamation text-[8px]"></i> {{ $message }}
                                ...
                                <div>
                                    <label
                                        class="text-[9px] sm:text-[10px] font-bold uppercase tracking-[0.15em] text-[#444] mb-2 block">Confirm
                                        Password</label>
                                    <div class="relative">
                                        <i
                                            class="fa-solid fa-check-double absolute left-3.5 top-1/2 -translate-y-1/2 text-[10px] text-[#333] pointer-events-none"></i>
                ...
                <div class="glass-card rounded-2xl sm:rounded-[2rem] overflow-hidden anim-up anim-d4">
                    <div class="px-5 sm:px-8 pt-5 sm:pt-6 pb-5 sm:pb-6 flex items-center justify-between">
                        <div class="flex items-center gap-2.5 sm:gap-3">
                            <div
                                class="w-8 h-8 sm:w-9 sm:h-9 rounded-xl bg-red-500/10 border border-red-500/15 flex items-center justify-center">
                            ...
                            <div>
                                ...
                                <p class="text-[8px] sm:text-[9px] text-[#444] font-medium">End your current session
                                </p>
                            </div>
                        </div>
                ...
                <!-- Footer -->
                <p
                    class="text-center text-[7px] sm:text-[8px] text-[#222] uppercase tracking-[0.2em] pt-6 anim-up anim-d5">
